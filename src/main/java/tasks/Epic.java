...
public class Epic extends Task {
    ...
    public Epic(Long subtaskIdNumber, String сaseName, String taskDescription, TaskStatus NEW,
                long duration, LocalDateTime startTime) {
        super(subtaskIdNumber, сaseName, taskDescription, TaskStatus.NEW, duration, startTime); // параметры супер-класса
        this.subtaskIdNumber = subtaskIdNumber;
    }
